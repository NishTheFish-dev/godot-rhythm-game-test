...
func _draw():
	...
	draw_arc(Vector2(960, 540), 470, (175*PI/180),(140*PI/180), 100, Color(0, 0, 1, 0.5), 20.0)
	draw_arc(Vector2(960, 540), 470, (130*PI/180),(95*PI/180), 100, Color(0, 1, 0, 0.5), 20.0)
	draw_arc(Vector2(960, 540), 470, (85*PI/180),(50*PI/180), 100, Color(1, 1, 0, 0.5), 20.0)
	draw_arc(Vector2(960, 540), 470, (40*PI/180),(5*PI/180), 100, Color(1, 0, 0, 0.5), 20.0)
